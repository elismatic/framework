...
function _layout(paddedNode) {
    ...
    paddedNode.layoutNode.setAbsoluteSize(parentSize[0] - paddedNode.options.left - paddedNode.options.right, parentSize[1] - paddedNode.options.top - paddedNode.options.bottom);
}
