    ...
    events: {
        '.circle': {
            'click': function ($timelines) {
                $timelines.queue([['animation-1', { duration: 800 }, function () {
                    return console.log('--> animation-1 complete!');
                }], ['animation-2', { duration: 800 }, function () {
                    return console.log('--> animation-2 complete!');
                }], ['animation-3', { duration: 800 }, function () {
                    return console.log('--> animation-3 complete!');
                }]], function () {
