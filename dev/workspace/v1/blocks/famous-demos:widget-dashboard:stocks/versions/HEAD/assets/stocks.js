    ...
    behaviors: {
        ...
        ".ticker-detail": {
            ...
            "content": function (selectedStock) {
                ...
                return "<h2>" + selectedStock.t + "</h2>" + "<h3>" + selectedStock.c + " (" + selectedStock.cp + "%)</h3>" + "<h4>" + selectedStock.l + "</h4>" + "<div class='chart' style='background:url(https://www.google.com/finance/getchart?q=" + selectedStock.t + ") 0px -10px no-repeat #222;'>";
            }
        },
